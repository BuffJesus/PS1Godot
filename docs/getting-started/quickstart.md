...
one button, and see it running in PCSX-Redux. See [`ROADMAP.md`](https://github.com/BuffJesus/PS1Godot/blob/main/ROADMAP.md){ target="_blank" }
...
[`authoring/audio/sequenced-music.md`](../authoring/audio/sequenced-music.md).
...
[`CLAUDE.md`](https://github.com/BuffJesus/PS1Godot/blob/main/CLAUDE.md){ target="_blank" } — worth a skim before modifying anything
substantial.
...
terminals. Full detail in [`installation.md`](installation.md).
...
More troubleshooting in [`installation.md`](installation.md). If something's busted and
...
or hitting something weird, [`installation.md`](installation.md) is the complete
